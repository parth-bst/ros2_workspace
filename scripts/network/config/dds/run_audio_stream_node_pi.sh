...
export FASTRTPS_DEFAULT_PROFILES_FILE=/home/parth/ros2_workspace/config/dds/discovery_client_pi.xml
...
echo ""
echo "🌐 DDS Discovery Client connecting to: $(grep -oP '<address>\K[^<]+' config/dds/discovery_client_pi.xml):11811"
